<template>
  <div class="flex bg-white justify-center">
    <div class="max-w-7xl px-6 lg:px-8">
      <div class="flex justify-center items-center mx-auto max-w-2xl">
        <div
          v-if="data.Data && data.Data.User1.ProgressData"
          class="mt-5 grid grid-cols-2 gap-10 rounded-2xl text-center"
        >
          <a
            href="#"
            v-for="(score, game) in data.Data.User2.ProgressData"
            :key="game"
          ...
          >
            ...
            <img src="/throphies11.jpg" alt="" class="" />
